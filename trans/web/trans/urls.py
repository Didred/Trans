...
urlpatterns = [
    ...
    url(r'^profile/edit/company/(?P<company_id>[0-9]+)$', views.edit_company, name='edit_company'),
    ...
    url(r'^company/(?P<company_id>[0-9]+)/review/(?P<review_id>[0-9]+)/(?P<user_id>[0-9]+)/edit/$', views.edit_review, name='edit_review'),
    url(r'^company/(?P<company_id>[0-9]+)/remove_review/(?P<review_id>[0-9]+)/(?P<user_id>[0-9]+)$', views.remove_review, name='remove_review'),
